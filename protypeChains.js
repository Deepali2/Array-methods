...
Vehicle.prototype.honk = () => {if (this.isRunning) return 'beep'};
...
// 3 -  Add a property on the object created from the Person function called family which is an empty array. This will involve you going back 
//and adding an additional line of code to your Person constructor you previously created in exercise 1.
...
// }
//ES6 syntax does not work. ES5 works
Person.prototype.fullName = function() {return this.firstName + ' ' + this.lastName};
Person.prototype.addToFamily = function(person){
  if (this.family.indexOf(person) === -1 && person instanceof Person) this.family.push(person);
...
// 1 - Implement your own version of Array.prototype.map. The function should accept a callback and return a new array with the result of 
