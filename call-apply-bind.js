...
function sumEvenArguments(){
  let vars = [].slice.call(arguments);
  return vars.reduce(function(acc, next){
    if (next % 2 === 0){
      return acc + next;
    }
    return acc; 
...
console.log(bind(addFourNumbers,this,1,2,3,4)()); // 10
console.log(bind(addFourNumbers,this)(1,2,3,4)); // 10
console.log(bind(addFourNumbers,this)(1,2,3,4,50,6,7,8,9,100)); // 10
...
Flip should return a new function that when invoked takes the correct number of required arguments to that function which are then reversed. H
INT - you will need to use the .length property on functions to figure out the correct amount of arguments. For example:
