...
In the outer function, you should create a variable called answer which is the result of a random number between 0 and 10 as well as a variable called guesses 
...
If the guess is too high return "Your guess is too high!" and if it is too low, return "Your guess is too low!". You should stop the user from guessing 
...
function guessingGame(amount){
  ...
  return function(guess){
   ...
   if (guesses === amount) {
    if (guess === answer) return 'This was your last guess AND You got it!';
    else if (guess < answer) return `No more guesses the answer was ${answer}`;
    else if (guess > answer) return `No more guesses the answer was ${answer}`;
   } 
...
console.log(game2(1))
console.log(game2(6)) // "You are all done playing!"